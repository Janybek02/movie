...
export const Title = () => {
  ...
  return (
    ...
    <div className="relative">
        ...
        <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-[#101616] hover:bg-white hover:text-[#101616] border-[1px] border-[#101616] focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2  ">Search</button>
    </div>
</div>
          </p>
        </div>
